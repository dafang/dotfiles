...
# the first way to install alias if the command exist
...
# the second way to install alias if the command exist
command -v mongoschema > /dev/null && alias ms='mongoschema'
command -v boom > /dev/null && alias ab='boom'
